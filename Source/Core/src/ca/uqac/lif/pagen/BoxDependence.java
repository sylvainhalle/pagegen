...
public abstract class BoxDependence
{
	/**
	 ...
	 */
	public BoxDependence(BoxProperty from, BoxProperty to)
	{
		super();
		m_from = from;
		m_to = to;
	...
	{
		if (o == null || !(o instanceof BoxDependence))
		{
			return false;
		}
		BoxDependence bd = (BoxDependence) o;
